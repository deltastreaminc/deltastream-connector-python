...
class Organization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organizationID", "defaultRoleName", "grantedRoles", "inheritedRoles"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "defaultRoleName": obj.get("defaultRoleName"),
            "grantedRoles": obj.get("grantedRoles"),
            "inheritedRoles": obj.get("inheritedRoles")
        })
        return _obj
