...
class ResultSetMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["encoding", "partitionInfo", "columns", "context"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.partition_info:
            for _item in self.partition_info:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "partitionInfo": [ResultSetPartitionInfo.from_dict(_item) for _item in obj.get("partitionInfo")] if obj.get("partitionInfo") is not None else None,
            "columns": [ResultSetColumnsInner.from_dict(_item) for _item in obj.get("columns")] if obj.get("columns") is not None else None,
