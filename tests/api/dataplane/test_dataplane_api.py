...
class TestDataplaneApi(unittest.TestCase):
    ...
    def test_get_statement_status(self) -> None:
        ...
        with patch.object(self.api.api_client, 'call_api', return_value=fake_response):
            with patch.object(self.api.api_client, 'response_deserialize', return_value=fake_deserialize):
                result = self.api.get_statement_status("stmt123", session_id="sess1", partition_id=0, timezone="UTC")
